...
exports.generateCoverLetter = exports.generateQuestions = exports.generateSuggestions = exports.analyzeResumeWithGemini = exports.calculateWeightedMatch = exports.GeminiResponseSchema = void 0;
...
exports.GeminiResponseSchema = zod_1.z.object({
    ...
    educationScore: zod_1.z.number().min(0).max(100),
    projectsScore: zod_1.z.number().min(0).max(100),
    certificationsScore: zod_1.z.number().min(0).max(100),
...
const calculateWeightedMatch = (analysis) => {
    const finalScore = (analysis.skillsScore * 0.5) +
...
exports.calculateWeightedMatch = calculateWeightedMatch;
const analyzeResumeWithGemini = async (resumeText, jobDescription) => {
  ...
  `;
    try {
        ...
        return exports.GeminiResponseSchema.parse(parsed);
    }
    catch (error) {
...
const generateSuggestions = async (resumeText, jobDescription) => {
    if (!ai) {
        return [
